    ...
    def initUI(self):
        ...
        def sign():
            ...
            if(not errorFlag):
                ...
                txt.move(10, 10)
                txt.setReadOnly(True)
                txt.setText("Here is your public key.\n" + keySTR.decode("utf-8"))
        ...
        def signSeed():
            ...
            def getSeed():
                try:
                    seed = openFileBin("Open seed").read()
                except:
                    errorFlag = True
                    errorDialog("No file chosen for opening")
        ...
        buttonNewFile.setToolTip('Random key generated by PyCrypto')
        ...
        buttonNewFile.setToolTip('Key generated from binary seed')
        buttonNewFile.resize(200, 30)
        buttonNewFile.move(50, 60)
        buttonNewFile.clicked.connect(signSeed)

        buttonNewFile = QPushButton('Sign with key from file', self)
        buttonNewFile.setToolTip('Key generated from signed file. UNSAFE!')
        buttonNewFile.resize(200, 30)
        buttonNewFile.move(50, 100)
        buttonNewFile.clicked.connect(signRNG)
